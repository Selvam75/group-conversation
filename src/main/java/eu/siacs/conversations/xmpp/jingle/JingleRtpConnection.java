...
public class JingleRtpConnection extends AbstractJingleConnection implements WebRTCWrapper.EventCallback {
    ...
    private void discoverIceServers(final OnIceServersDiscovered onIceServersDiscovered) {
        SharedPreferences
            sharedpreferences = xmppConnectionService.getSharedPreferences("CALL_SERVER", Context.MODE_PRIVATE);
    /* SharedPreferences.Editor editor = sharedpreferences.edit();
     editor.putString("turn",turntext.getText().toString());
     editor.putString("sturn",stuntext.getText().toString());
     ...
     editor.commit();*/
        ...
        // String STURN_TURN_SERVER = "chat.joiint.com";
        //"service71.secureother.com"
         ...
         *//*
         ...
         String port = sharedpreferences.getString("port","443");
         ...
         final PeerConnection.IceServer.Builder iceServerBuilder = PeerConnection.IceServer
                 .builder(String.format("%s:%s:%s?transport=%s", "stun", IP.wrapIPv6(sturnSErver), port, "udp"));
     ...
     }
     {
         ...
         *//*
         ...
         String username  = sharedpreferences.getString("username","joiint");
         String password = sharedpreferences.getString("password","joiint123##");
         final PeerConnection.IceServer.Builder iceServerBuilder2 = PeerConnection.IceServer
                 .builder(String.format("%s:%s:%s?transport=%s", "turn", IP.wrapIPv6(turnSErver), port, "tcp"));
         iceServerBuilder2.setTlsCertPolicy(PeerConnection.TlsCertPolicy.TLS_CERT_POLICY_INSECURE_NO_CHECK);
         if (username != null && password != null) {
             iceServerBuilder2.setUsername(username);
             iceServerBuilder2.setPassword(password);
         }
         final PeerConnection.IceServer iceServer2 = iceServerBuilder2.createIceServer();
         Log.d(Config.LOGTAG, id.account.getJid().asBareJid() + ": discovered ICE Server: " + iceServer2);
     ...
     /*{
         ...
         String sturnSErver  = sharedpreferences.getString("sturn","stun.l.google.com");
         String port = sharedpreferences.getString("port","19302");
         *//**
         *
         * stun server
         *
     ...
     }
     {
         ...
         String sturnSErver  = sharedpreferences.getString("sturn","stun1.l.google.com:19302");
         String port = sharedpreferences.getString("port","19302");
         *//**
         *
         * stun server
     ...
     }
     {
         ...
         String sturnSErver  = sharedpreferences.getString("sturn","stun1.l.google.com");
         String port = sharedpreferences.getString("port","19302");
         *//**
         *
         * stun server
     ...
     }
     {
         ...
         String sturnSErver  = sharedpreferences.getString("sturn","stun2.l.google.com");
         String port = sharedpreferences.getString("port","19302");
         *//**
         *
         * stun server
     ...
     }
     {
         ...
         String sturnSErver  = sharedpreferences.getString("sturn","stun3.l.google.com");
         String port = sharedpreferences.getString("port","19302");
         *//**
         *
         * stun server
     ...
     }
     {
         ...
         String sturnSErver  = sharedpreferences.getString("sturn","stun4.l.google.com");
         String port = sharedpreferences.getString("port","19302");
         *//**
         *
         * stun server
    ...
    /* if (id.account.getXmppConnection().getFeatures().externalServiceDiscovery())
     {
         ...
         Log.d("REQUEST ICE",String.valueOf(request.toString()));

         xmppConnectionService.sendIqPacket(id.account, request, (account, response) -> {
             Log.d("RESPONSE ICE",String.valueOf(response.toString()));
             ImmutableList.Builder<PeerConnection.IceServer> listBuilder = new ImmutableList.Builder<>();
             if (response.getType() == IqPacket.TYPE.RESULT)
             {
                 Log.d("serv session init from xmpp",String.valueOf(response.toString()));
